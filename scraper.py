...
def normalise(string):
    ...
    normalisedString = demojize(string)
    return normalisedString


def format(website, headline, link):

    fString = website + "," + headline.replace(",", "|").replace("Video", "(Video) ").replace(
        "\n", "") + "," + link + "\n"
    return fString
    ...
    for page in NEWSPAGES:
        ...
        if index == 0:
            ...
            for container in containers:
                ...
                try:
                    link = "=HYPERLINK(\"https://www.bbc.com" + \
                        container.get("href") + "\")"
                except:
                    link = "null"

                headline = normalise(headline)
                fileline = format(website, headline, link)
                f.write(fileline)
        ...
        if index == 1:
            ...
            containers.extend(soupPage.findAll(
            ...
            for container in containers:
                ...
                try:
                    link = "=HYPERLINK(\"https://www.reuters.com" + \
                        container.a.get("href") + "\")"
                except:
                    link = "null"
        ...
        if index == 2:
            ...
            # grab each headline container
            containers = soupPage.findAll(
                "div", {"class": ["css-10wtrbd", "css-1l4spti"]})
            ...
            for container in containers:
                ...
                try:
                    link = "=HYPERLINK(\"https://www.nytimes.com" + \
                        container.h2.a.get("href") + "\")"
                except:
                    try:
                        link = "=HYPERLINK(\"https://www.nytimes.com" + \
                            container.a.get("href") + "\")"
        ...
        if index == 4:
            ...
            for container in containers:
                ...
                try:
                    link = "=HYPERLINK(\"https://www.rt.com" + \
                        container.a.get("href") + "\")"
                except:
                    link = "null"
